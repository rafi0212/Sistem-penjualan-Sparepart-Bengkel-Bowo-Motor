...
<body>
    <div class="container">
      ...
      <div class="kepala-table">
            <div class="kt">
                <h2>Manage Barang</h2>
                <a href="./barangtambah.php" class="add-btn" id="addCustomerBtn">+Tambah</a>
            </div>
            ...
            $query = mysqli_query($koneksi, "SELECT * FROM barang LIMIT $start, $limit");
            while ($data=mysqli_fetch_array($query)){
                ...
                <td>
				<a class="edit" href="barangubah.php?kode_barang=<?php echo $data['kode_barang'];?>" ><i class="fas fa-edit"></i></a> |
				<a class="hapus" href="baranghapus.php?kode_barang=<?php echo $data['kode_barang']; ?>" onclick="return confirm('yakin hapus?')"><i class="fas fa-trash"></i></a>				
			</td>
            </tr>
            </tr>
            <?php } 
            //include 'barangubah.php'?>
                </tbody>
            </table>
        </div>
